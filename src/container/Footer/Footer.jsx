...
const Footer = () => {
  ...
  const handleSubmit = () => {
    ...
    client.create(contact).then(()=>formValidation()).then(() => {
      setLoading(false)
        ...
        <>
          ...
          <div className="app__footer-cards">
            <div className="app__footer-card ">
              ...
              <a href="mailto:pregustavomium@gmail.com" className="p-text">pregustavomium@gmail.com</a>
            </div>
            <div className="app__footer-card">
          ...
          <div className="app__footer-form app__flex">
            ...
            <button type="button" className={loading && 'button-opacity'} onClick={handleSubmit}>{!loading ? 'Send Message' : 'Sending...'}</button>
          </div>
        </>
      ) : (
        <div>
